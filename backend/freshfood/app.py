...
from freshfood.extensions import bcrypt, cache, db, migrate, jwt, cors

from freshfood import commands, customer
...
def register_blueprints(app):
    ...
    cors.init_app(customer.views.blueprint, origins=origins)
...
def register_shellcontext(app):
    ...
    def shell_context():
        ...
        return {
            'db': db,
            'Customer': customer.models.Customers,
            # 'UserProfile': profile.models.DriverProfile,
