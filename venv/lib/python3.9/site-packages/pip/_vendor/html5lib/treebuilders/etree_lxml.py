...
from pip._vendor.html5lib.treebuilders import base
from pip._vendor.html5lib.constants import DataLossWarning
from pip._vendor.html5lib import constants
from pip._vendor.html5lib.treebuilders import etree as etree_builders
