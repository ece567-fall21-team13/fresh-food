...
from pip._vendor.html5lib.constants import asciiLetters, asciiUpper2Lower
from pip._vendor.html5lib.constants import digits, hexDigits, EOF
from pip._vendor.html5lib.constants import tokenTypes, tagTokenTypes
